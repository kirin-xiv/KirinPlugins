...
internal class MessageBox: Window
{
    ...
    public override void Draw()
    {
        ...
        {
            if ( ImGui.Button( $"Ok##MessageBoxButton", new( fButtonWidth, EorzeanScribe.BUTTON_Y.Scale() ) ) )
            {
        ...
        {
            if ( ImGui.Button( $"Cancel##MessageBoxButton", new( fButtonWidth, EorzeanScribe.BUTTON_Y.Scale() ) ) )
            {
        ...
        {
            if ( ImGui.Button( $"Abort##MessageBoxButton", new( fButtonWidth, EorzeanScribe.BUTTON_Y.Scale() ) ) )
            {
        ...
        {
            if ( ImGui.Button( $"Yes##MessageBoxButton", new( fButtonWidth, EorzeanScribe.BUTTON_Y.Scale() ) ) )
            {
        ...
        { 
            if ( ImGui.Button( $"No##MessageBoxButton", new( fButtonWidth, EorzeanScribe.BUTTON_Y.Scale() ) ) )
            {
        ...
        {
            if ( ImGui.Button( $"Never Show Again##MessageBoxButton", new( fButtonWidth, EorzeanScribe.BUTTON_Y.Scale() ) ) )
            {
